...
main() {
  echo -e "Build Microsoft Windows Server Datacenter 2016 Templates En for VMware vSphere."
  ...
  pushd "${WORKSPACE}/packer-vsphere/template/windows-server-2016-datacenter-en"
  ...
  mc cp "${WORKSPACE}/packer-vsphere/template/windows-server-2016-datacenter-en" minio-pdc/templates --recursive
  echo "Done."
}
