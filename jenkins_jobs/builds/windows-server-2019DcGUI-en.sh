...
main() {
  ...
  pushd "${WORKSPACE}/packer-vsphere/template/windows-server-2019-datacenter-en"
  ls
  ...
  mc cp "${WORKSPACE}/packer-vsphere/template/windows-server-2019-datacenter-en" minio-pdc/templates --recursive
  echo "Done."
}
