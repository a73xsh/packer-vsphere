...
main() {
  echo -e "Build Microsoft Windows Server Standard 2019 Core Templates En for VMware vSphere."
  ...
  pushd "${WORKSPACE}/packer-vsphere/template/windows-server-2019-standard-core-en"
  ls
  ...
  mc cp "${WORKSPACE}/packer-vsphere/template/windows-server-2019-standard-core-en" minio-pdc/templates --recursive
  echo "Done."
}
