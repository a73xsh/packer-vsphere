...
main() {
  echo -e "Build Microsoft Windows Server Standard 2016 Templates for VMware vSphere."
  ...
  pushd "${WORKSPACE}/packer-vsphere/template/windows-server-2016-standard-en"
  ...
  mc cp "${WORKSPACE}/packer-vsphere/template/windows-server-2016-standard-en" minio-pdc/templates --recursive
  echo "Done."
}
